...
"""
HEAD APP - PRECIPITATION H64 PRODUCT  - HSAF Engines for Analyzing Datasets
...
project_name = 'head'
alg_name = 'Application for processing H64 precipitation product'
alg_type = 'Package'
alg_version = '1.0.0'
alg_release = '2023-06-07'
# -------------------------------------------------------------------------------------
