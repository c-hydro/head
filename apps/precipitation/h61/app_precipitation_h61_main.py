...
"""
HEAD APP - PRECIPITATION H61 PRODUCT  - HSAF Engines for Analyzing Datasets
...
python app_precipitation_h61_main.py -settings_file configuration.json -time "YYYY-MM-DD HH:MM"

Version(s):
20250715 (1.0.2) --> Fix bug for managing old and new file format (changed from 2025-07-01 to present)
20241118 (1.0.1) --> Fix bug for managing file with defined/not defined variables
...
project_name = 'head'
alg_name = 'Application for processing H61 precipitation product'
alg_type = 'Package'
alg_version = '1.0.2'
