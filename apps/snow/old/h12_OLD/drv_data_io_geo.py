...
from lib_utils_apps_geo import defineGeoGrid, defineGeoCorner, defineGeoHeader, \
...
class DataGeo:
    ...
    def getDataGeo(self):
        ...
        if bFileName and isfile(self.__sFileName):
            ...
            oLogStream.error(' =====> ERROR: both filename and geographical box are undefined! (' +
                             self.__sFileName + ')')
    ...
    def __addGrid(self):
        ...
        if self.__oGeoObject:
            ...
            if bCheckDomain:
                ...
                oLogStream.warning(' =====> WARNING: add Data to domain reference failed! Domains are different!')
        else:
            pass
