...
from lib_utils_op_system import defineFileExt
...
class Drv_Data_IO:
    ...
    def __init__(self, sFileName, sFileMode=None, sFileType=None):
        ...
        elif sFileName.endswith('grb') or sFileName.endswith('grib') or sFileName.endswith('grib2'):

            sFileType = 'grib'
            self.oFileWorkspace = FileGrib(sFilePath, sFileName, sFileType, sFileMode)

        elif sFileName.endswith('H5') or sFileName.endswith('hdf5'):

            sFileType = 'hdf5'
            self.oFileWorkspace = FileHDF5(sFilePath, sFileName, sFileType, sFileMode)

        elif sFileName.endswith('hdf4') or sFileName.endswith('hdf'):
...
class FileUnknown:
    ...
    def printInfo(self):
        oLogStream.error(' =====> WARNING: file ' + join(self.sFilePath, self.sFileName) +
                         ' has unknown extension! Please check library or file format!')
        raise RuntimeError(' =====> ERROR: file format unknown!')
    # --------------------------------------------------------------------------------
...
class FileBinary:
    ...
    def setFileLibIO(self):
        ...
        import lib_data_io_binary as file_library
...
class FileGrib:
    ...
    # Method to set library I/O function(s)
    def setFileLibIO(self):
        import lib_data_io_grib as file_library
        self.oFileLibrary = file_library
...
class FileAscii:
    ...
    def setFileLibIO(self):
        ...
        import lib_data_io_ascii as file_library
        self.oFileLibrary = file_library
...
class FileNetCDF:
    ...
    def setFileLibIO(self):
        ...
        import lib_data_io_netcdf as file_library
        self.oFileLibrary = file_library
...
class FileHDF5:
    ...
    # Method to set library I/O function(s)
    def setFileLibIO(self):
        import lib_data_io_hdf5 as file_library
        self.oFileLibrary = file_library
...
class FileHDF4:
    ...
    # Method to set library I/O function(s)
    def setFileLibIO(self):
        import lib_data_io_hdf4 as file_library
        self.oFileLibrary = file_library
...
class FileCSV:
    ...
    # Method to set library I/O function(s)
    def setFileLibIO(self):
        import lib_data_io_csv as file_library
        self.oFileLibrary = file_library
