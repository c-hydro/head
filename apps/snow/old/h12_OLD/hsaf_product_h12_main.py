"""
HSAF Processing Tool - SNOW PRODUCT H12
...
python3 hsaf_product_h12_main.py -settings_file configuration_product.json -time "YYYY-MM-DD HH:MM"

Version:
20240131 (1.0.1) --> Refactor release
20180629 (1.0.0) --> Beta release
"""
# -------------------------------------------------------------------------------------
...
from drv_data_io_h12 import DataProductBuilder, DataProductAnalyzer, DataProductFinalizer, DataProductCleaner
# -------------------------------------------------------------------------------------
...
def GetArgs():
    ...
    if oParserValue.sSettingFile:
        ...
        sSettingsFile = 'fp_configuration_hsaf_h12.json'
