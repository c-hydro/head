...
from lib_default_args import sTimeFormat, sTimeType, sLoggerName
from lib_utils_apps_time import getTimeNow, getTimeFrom, getTimeTo, getTimeSteps, getTimeRun, computeTimeRestart
...
class DataTime:
    ...
    def __computeTimeCheckSteps(self):
        ...
        if self.iTimeStepCheck > 0:
            ...
            oLogStream.warning(' =====> WARNING: Data check steps are set less than 0! Update to 0')
            a1oTimeCheck = [self.sTimeRun]
