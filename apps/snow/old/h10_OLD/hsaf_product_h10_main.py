"""
HSAF Processing Tool - SNOW PRODUCT H10
...
python3 hsaf_product_h10_main.py -settings_file configuration_product.json -time "YYYY-MM-DD HH:MM"

Version:
20240131 (4.1.0) --> Refactor release
20180713 (4.0.0) --> Beta release with new codes for Python 3
20141204 (3.0.0) --> Release derived from script(s) version 2 and Python 2.7
"""
# -------------------------------------------------------------------------------------
...
from drv_data_io_h10 import DataProductBuilder, DataProductAnalyzer, DataProductFinalizer, DataProductCleaner
# -------------------------------------------------------------------------------------
...
def GetArgs():
    ...
    if oParserValue.sSettingFile:
        ...
        sSettingsFile = 'fp_configuration_hsaf_h10.json'
...
def main():
    ...
    sProgramVersion = '4.1.0'
    sProjectName = 'HSAF'
    sAlgType = 'Product H10'
    sAlgName = 'PROCESSING TOOL'
