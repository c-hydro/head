...
python hsaf_product_h13_main.py -settingfile configuration_product.json -time "YYYY-MM-DD HH:MM"
...
from drv_data_io_h13 import DataProductBuilder, DataProductAnalyzer, DataProductFinalizer, DataProductCleaner
# -------------------------------------------------------------------------------------
...
def GetArgs():
    ...
    if oParserValue.sSettingFile:
        ...
        sSettingsFile = 'fp_configuration_hsaf_h13.json'
