...
"""
HEAD APP - SNOW H12 PRODUCT  - HSAF Engines for Analyzing Datasets
...
python app_snow_h12_main.py -settings_file configuration.json -time "YYYY-MM-DD HH:MM"

Version(s):
20240610 (2.0.0) --> Refactor to head package
...
project_name = 'head'
alg_name = 'Application for processing H12 snow product'
alg_type = 'Package'
alg_version = '2.0.0'
