...
from lib_data_io_grib2 import read_file_grib2
        ...
        for alg_time_step in self.alg_time_datasets:
            ...
            if not os.path.exists(file_path_anc_raw_step):
                ...
                if os.path.exists(file_path_src_step):
                    ...
                    # get dataset source
                    obj_data_src, obj_geo_src = read_file_grib2(
                        file_path_tmp_step, file_variables=self.variables_src,
                        var_name_geo_x=geo_var_name_x, var_name_geo_y=geo_var_name_y)

                    # organize variable(s) source
                    vars_src_step = organize_data(
                        obj_data_src, obj_geo_src,
                        var_name_geo_x=geo_var_name_x, var_name_geo_y=geo_var_name_y, **self.settings_organize_data)
