...
def adapt_data(obj_collections_src, var_name_geo_x='longitude', var_name_geo_y='latitude',):

    # get data and time information
    obj_data_src = obj_collections_src['data']
    obj_time_src = obj_collections_src['time']
