...
"""
HEAD APP - SOIL MOISTURE H122 PRODUCT  - HSAF Engines for Analyzing Datasets
...
Version(s):
20240610 (1.0.0) --> First development
"""
...
project_name = 'head'
alg_name = 'Application for processing H122 soil moisture product'
alg_type = 'Package'
alg_version = '1.0.0'
alg_release = '2023-06-10'
# -------------------------------------------------------------------------------------
...
def main():
    ...
    alg_time_now, alg_time_range, alg_time_chunks = set_time_info(
        ...
        time_frequency=alg_data_settings['time']['time_frequency_window'],
        time_rounding=alg_data_settings['time']['time_rounding_window'],
        time_frequency_chunks=alg_data_settings['time']['time_frequency_chunks'],
        time_rounding_chunks=alg_data_settings['time']['time_rounding_chunks'],
        time_reverse=True)
    # -------------------------------------------------------------------------------------
    ...
    for alg_time_reference, alg_time_datasets in alg_time_chunks.items():
        ...
        drv_data_dynamic = DrvDataDynamic(
            alg_time_reference, alg_time_now, alg_time_datasets, alg_data_static, alg_data_settings)
        # organize datasets
