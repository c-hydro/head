...
"""
HEAD APP - SOIL MOISTURE H26 PRODUCT  - HSAF Engines for Analyzing Datasets
...
python app_sm_h26_main.py -settings_file configuration.json -time "YYYY-MM-DD HH:MM"
...
project_name = 'head'
alg_name = 'Application for processing H26 soil moisture product'
alg_type = 'Package'
alg_version = '1.0.0'
