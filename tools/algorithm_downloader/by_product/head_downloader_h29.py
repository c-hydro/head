...
# ----------------------------------------------------------------------------------------
# Script information
SCRIPT_NAME = "HEAD DOWNLOADER - HSAF SOIL MOISTURE H29 (ASCAT METOP A/B/C)"
...
LOCAL_FOLDER_RAW = os.environ.get(
    "LOCAL_FOLDER_RAW",
    "/share/HSAF_SM/ascat/nrt/h29/%YYYY/%MM/%DD/%HH/",
)
...
def main(argv: list[str]) -> int:
    ...
    for offset in range(HOURS_BACK + 1):
        ...
        file_pattern = f"*H29_C_LIIB_{date_step_str}{hour_get}*"
