...
script_name='HEAD - DOWNLOADER - ROOT ZONE SOIL MOISTURE ECMWF'
...
data_folder_dst_list=(
	"/share/HSAF_SM/ecmwf/nrt/h14/%YYYY/%MM/%DD/"
	"/share/HSAF_SM/ecmwf/nrt/h14/%YYYY/%MM/%DD/"
	"/share/HSAF_SM/ecmwf/dr/h27_h140/%YYYY/%MM/%DD/"
	"/share/HSAF_SM/ecmwf/dr/h27_h140/%YYYY/%MM/%DD/"
	"/share/HSAF_SM/ecmwf/dr/h141/%YYYY/%MM/"
	"/share/HSAF_SM/ecmwf/dr/h141/%YYYY/%MM/%DD/"
	"/share/HSAF_SM/ecmwf/dr/h142/%YYYY/%MM/"
	"/share/HSAF_SM/ecmwf/dr/h142/%YYYY/%MM/%DD/"
...
for ((i=0;i<${#data_description_list[@]};++i)); do
	...
	if [[ $time_period_now -ge $time_period_start ]] && [[ $time_period_now -le $time_period_end ]] ; then
		...
		if [ "${data_active_step}" = true ] ; then
			...
			# start from last day to actual time
