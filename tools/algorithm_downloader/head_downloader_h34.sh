...
# =======================================================================================
# Script information
script_name='HEAD DOWNLOADER - HSAF PRODUCT SNOW H34 - REALTIME'
...
# -------------------------------------
DATA_FOLDER_RAW="${DATA_FOLDER_RAW:-/share/HSAF_SNOW/nrt/h34/%YYYY/%MM/%DD/}"
DAYS="${DAYS:-10}"
...
FTP_FOLDER="${FTP_FOLDER:-/products/h34/h34_cur_mon_data}"

# File pattern template [h34_%YYYY%MM%DD_day_merged.H5.gz]
FILE_PATTERN_TEMPLATE="${FILE_PATTERN_TEMPLATE:-h34_%YYYY%MM%DD_day_merged.H5.gz}"
