...
# =======================================================================================
# Script information
script_name='HEAD DOWNLOADER - HSAF PRODUCT SNOW H12 - REALTIME'
...
# -------------------------------------
DATA_FOLDER_RAW="${DATA_FOLDER_RAW:-/share/HSAF_SNOW/nrt/h12/%YYYY/%MM/%DD/}"
DAYS="${DAYS:-10}"
...
FTP_FOLDER="${FTP_FOLDER:-/products/h12/h12_cur_mon_data}"

# File pattern template [h12_%YYYY%MM%DD_day_merged.grib2.gz]
FILE_PATTERN_TEMPLATE="${FILE_PATTERN_TEMPLATE:-h12_%YYYY%MM%DD_day_merged.grib2.gz}"
