...
#######################################
LOCK_DIR="/share/LOCK"
LOCK_BASENAME="head_downloader_products_snow_conn_"
MAX_SLOTS=1    # <-- change here if you want more/less
ACQUIRED_LOCK=""
...
FTP_FOLDER_H10="/products/h10/h10_cur_mon_data/"
FTP_FOLDER_H12="/products/h12/h12_cur_mon_data/"
FTP_FOLDER_H13="/products/h13/h13_cur_mon_data/"
FTP_FOLDER_H34="/products/h34/h34_cur_mon_data/"
...
echo "================================================================"
echo "  HSAF FTP MIRROR - PRODUCTS SNOW - START"
...
echo
echo "================================================================"
echo "  HSAF FTP MIRROR - PRODUCTS SNOW - END"
echo "  Timestamp: $(date +"%Y-%m-%d %H:%M:%S")"
echo "================================================================"
