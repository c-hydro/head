...
#######################################
LOCK_DIR="/share/LOCK"
LOCK_BASENAME="head_downloader_products_sm_conn_"
MAX_SLOTS=2    # <-- change here if you want more/less
ACQUIRED_LOCK=""
...
FTP_FOLDER_H14="/products/h14/h14_cur_mon_grib/"
FTP_FOLDER_H26="/products/h26/h26_cur_mon_nc/"
FTP_FOLDER_H29="/products/h29/h29_cur_mon_nc/"
FTP_FOLDER_H122="/products/h122/h122_cur_mon_nc/"
...
echo "================================================================"
echo "  HSAF FTP MIRROR - PRODUCTS SM - START"
...
# You can tune these as you like (1/1 if you want to be gentle)
...
$(for rf in "${REMOTE_FOLDERS[@]}"; do
    ...
    # Create local folder if missing (local side)
    mkdir -p "$local_dir"
...
echo
echo "================================================================"
echo "  HSAF FTP MIRROR - PRODUCTS SM - END"
echo "  Timestamp: $(date +"%Y-%m-%d %H:%M:%S")"
echo "================================================================"
