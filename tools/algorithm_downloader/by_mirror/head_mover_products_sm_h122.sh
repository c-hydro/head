...
SRC_DIR = "/share/HSAF_MIRROR/h122_cur_mon_nc"
DST_DIR = "/share/HSAF_SM/ascat/nrt/h122"

# your template:
#   "*H122_C_LIIB_YYYYMMDDHH*"
#
# Regex to extract date & hour
FILENAME_REGEX = re.compile(
    r".*H122_C_LIIB_(?P<date>\d{8})(?P<hour>\d{2}).*"
)
...
print(f"Syncing last {N_DAYS} days of H122 files…")
...
for offset in range(N_DAYS):
    ...
    pattern = os.path.join(SRC_DIR, f"*H122_C_LIIB_{date_step}" + "??*")
