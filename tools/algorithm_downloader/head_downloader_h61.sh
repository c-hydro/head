...
# ----------------------------------------------------------------------------------------
# Script information
script_name='HEAD DOWNLOADER - HSAF PRODUCT PRECIPITATION H61/H61B - REALTIME'
...
if [ "$script_mode" == 'realtime' ]; then
	ftp_folder_raw="/products/h60/h61_cur_mon_data/" # realtime
elif [ "$script_mode" == 'history' ]; then 
    ftp_folder_raw="/hsaf_archive/h61/%YYYY/%MM/%DD/%HH/" # history
else 
