...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HEAD TRANSFER - PRECIPITATION - REALTIME'
...
CONTROL_PATH=/tmp/rsync19_control_path_precipitation
# Days period
declare -a list_days=(5 5)
# Declare local folder(s) list
declare -a list_folders=(
	"/share/DEWETRA/nrt/h60/"
    "/share/DEWETRA/nrt/h61/"
    "/share/DEWETRA/nrt/h64/"
)

# Declare filename(s) list
declare -a list_filename=(  
	"/share/DEWETRA/ancillary/sync_data/head_transfer_precipitation_h60.txt" 
    "/share/DEWETRA/ancillary/sync_data/head_transfer_precipitation_h61.txt" 
    "/share/DEWETRA/ancillary/sync_data/head_transfer_precipitation_h64.txt"
)
