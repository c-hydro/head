...
#-----------------------------------------------------------------------------------------
# Script information
script_name='DOOR TRANSFER - HSAF FILE(S) - SNOW'
...
# Days period
declare -a list_days=(4 4 4)
# Declare local folder(s) list
declare -a list_folders=(
    "/share/HSAF_SNOW/dewetra/h10/"
    "/share/HSAF_SNOW/dewetra/h12/"
    "/share/HSAF_SNOW/dewetra/h13/"
)

# Declare filename(s) list
declare -a list_filename=(  
    "/share/HSAF_SNOW/ancillary/sync_data/hsaf_file_h10.txt" 
    "/share/HSAF_SNOW/ancillary/sync_data/hsaf_file_h12.txt" 
    "/share/HSAF_SNOW/ancillary/sync_data/hsaf_file_h13.txt" 
)
# Declare server folder
declare -a dst_base_dir=/share/archivio/experience/data/HSAF
#-----------------------------------------------------------------------------------------

LOCK_FILE=/tmp/sync19_lock_hsaf_snow
