...
#-----------------------------------------------------------------------------------------
# Script information
script_name='DOOR TRANSFER - HSAF FILE(S) - PRECIPITATION'
...
declare -a list_folders=(
	"/share/HSAF_PRECIPITATION/dewetra/h60/"
    "/share/HSAF_PRECIPITATION/dewetra/h61/"
)

# Declare filename(s) list
declare -a list_filename=(  
	"/share/HSAF_PRECIPITATION/ancillary/sync_data/hsaf_file_h60.txt" 
    "/share/HSAF_PRECIPITATION/ancillary/sync_data/hsaf_file_h61.txt" 
)
