...
script_name='HEAD - SHRINKER - SNOW PRODUCT - NRT HISTORY'
...
data_description_list=(
	"SNOW MAP 00:00 - H10 - NC" 
	"SNOW MAP 00:00 - H12 - NC"
	"SNOW MAP 00:00 - H13 - NC"
)
...
data_file_src_list=(
	"hsaf_h10_%YYYY%MM%DD0000_italy.nc"
	"hsaf_h12_%YYYY%MM%DD0000_italy.nc"
	"hsaf_h13_%YYYY%MM%DD0000_italy.nc"
)
...
data_folder_src_list=(
	"/share/HSAF_SNOW/dewetra/h10/%YYYY/%MM/%DD/"
	"/share/HSAF_SNOW/dewetra/h12/%YYYY/%MM/%DD/"
	"/share/HSAF_SNOW/dewetra/h13/%YYYY/%MM/%DD/"
)
	
data_folder_dst_list=(
	"/share/HSAF_SNOW/dewetra/h10_compressed/%YYYY/%MM/%DD/"
	"/share/HSAF_SNOW/dewetra/h12_compressed/%YYYY/%MM/%DD/"
	"/share/HSAF_SNOW/dewetra/h13_compressed/%YYYY/%MM/%DD/"
)
