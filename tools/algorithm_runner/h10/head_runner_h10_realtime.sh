...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HEAD RUNNER - SNOW H10 - SNOW COVER - REALTIME'
...
script_file='/home/idrologia/package/package_head/apps/snow/h10/app_snow_h10_main.py'
settings_file='/home/idrologia/project/hsaf/algorithm_runner/h10/head_runner_h10_realtime.json'
