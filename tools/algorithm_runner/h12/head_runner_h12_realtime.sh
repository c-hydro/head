...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HEAD RUNNER - SNOW H12 - SNOW COVER - REALTIME'
...
script_file='/home/idrologia/package/package_head/apps/snow/h12/app_snow_h12_main.py'
settings_file='/home/idrologia/project/hsaf/algorithm_runner/h12/head_runner_h12_realtime.json'
