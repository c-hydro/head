...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HEAD RUNNER - SNOW H13 - SNOW COVER - REALTIME'
...
script_file='/home/idrologia/package/package_head/apps/snow/h13/app_snow_h13_main.py'
settings_file='/home/idrologia/project/hsaf/algorithm_runner/h13/head_runner_h13_realtime.json'
