...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HEAD RUNNER - PRECIPITATION H61/H61B - ACCUMULATED 1 HOUR - HISTORY'
...
settings_file='/home/idrologia/project/hsaf/algorithm_runner/h61/head_runner_h61_1h_history.json'

# Get information (-u to get gmt time)
time_now=$(date +"%Y-%m-%d %H:00")
time_now='2023-07-10 00:00' # DEBUG 

# Get time days execution
time_period_days=1500
#-----------------------------------------------------------------------------------------
