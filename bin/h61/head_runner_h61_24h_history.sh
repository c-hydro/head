...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HEAD RUNNER - PRECIPITATION H61/H61B - ACCUMULATED 24 HOUR - HISTORY'
...
settings_file='/home/idrologia/project/hsaf/algorithm_runner/h61/head_runner_h61_24h_history.json'
