...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HEAD ENVIRONMENT - PYTHON3 LIBRARIES FOR PACKAGE - RUNNER TYPE - CONDA'
...
fp_env_tag_default='head_runner'
...
if [ -f $fp_env_file_requirements ] ; then
	...
	conda create --yes --name $fp_env_folder_libraries numpy scipy matplotlib==3.1.3 gdal h5py cartopy==0.17 pandas rasterio netCDF4 cython xarray=0.18.0 bottleneck dask pip python=3.7
